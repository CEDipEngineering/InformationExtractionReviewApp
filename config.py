...
# ---------------------------------------------------------------------------
DATABRICKS_CONFIG_PROFILE: str = os.environ.get("DATABRICKS_CONFIG_PROFILE", "e2")

# ---------------------------------------------------------------------------
# SQL warehouse
# ---------------------------------------------------------------------------
SQL_WAREHOUSE_ID: str = os.environ.get("SQL_WAREHOUSE_ID", "c741aaf0c2ad0829")

# ---------------------------------------------------------------------------
# Source table
# ---------------------------------------------------------------------------
TABLE_NAME: str = os.environ.get("TABLE_NAME", "pedro_zanela.ia.input_ocr_gabarito")

# ---------------------------------------------------------------------------
# Destination table (writeback)
# Reviewed/corrected JSON is upserted here, keyed on COL_PDF_PATH.
# ---------------------------------------------------------------------------
DEST_TABLE_NAME: str = os.environ.get("DEST_TABLE_NAME", "cedip.ai.output_ocr_feedback")
